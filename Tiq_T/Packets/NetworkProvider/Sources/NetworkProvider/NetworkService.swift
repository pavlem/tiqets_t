...
open class NetworkService {
    ...
    public func load<M: Decodable>(urlString: String, path: String, method: RequestMethod, params: JSON?, headers: HTTPHeaders?, completion: @escaping (Result<M?, NetworkError>) -> ()) -> URLSessionDataTask? {
